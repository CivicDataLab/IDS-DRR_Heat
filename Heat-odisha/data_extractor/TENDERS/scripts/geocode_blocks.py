...
OD_BLOCKS = gpd.read_file(root+r'/Maps/od_ids-drr_shapefiles/odisha_block_final.geojson', driver='GeoJSON')
...
MASTER_DF.to_csv(root+'/data_extractor/TENDERS/data/heattenders_blockgeotagged.csv')
