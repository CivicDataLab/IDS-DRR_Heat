"""
geocode_district_heat.py

Heat-tender counterpart of geocode_district.py (which geotags Assam's FLOOD
tenders). Same village/revenue-circle/sub-district matching logic and the
same Assam-specific district-identifier dictionaries, but reads the output
of heat_tenders.py (heat_tenders_all.csv) instead of flood_tenders_all.csv,
and writes heattenders_districtgeotagged.csv.
"""
